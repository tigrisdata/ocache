...
Per pass: at most `walkBudget` walks × (file open + header-hop + ≤4,096 point-gets) ≈ tens of milliseconds. No metadata scan is ever taken; memory is O(live segments) for walk recency.
